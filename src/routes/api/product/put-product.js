...
module.exports = (req, res)=>{
    ...
    if(!id){
        ...
        con.query(`UPDATE product SET product_name = '${name}', price = '${price}', description = '${description}', width_inches = '${width}', length_inches = '${length}', height_inches = '${height}', weight_lbs = '${weight}', maker = '${maker}' 
